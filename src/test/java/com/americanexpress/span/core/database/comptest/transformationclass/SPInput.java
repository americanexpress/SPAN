...
public class SPInput {
    ...
    @Field(name = "in_str", transformationClass = BooleanToString.class)
    ...
    private Integer inInteger = 0;

    @Field(name = "in_long")
    private long inLong = 0;

    @Field(name = "in_longObj")
    private Long inLongObj = 0L;

    @Field(name = "in_float")
    private float inFloat = 0;

    @Field(name = "in_floatObj")
    private Float inFloatObj = 0F;

    @Field(name = "in_double")
    private double inDouble = 0;

    @Field(name = "in_doubleObj")
    private Double inDoubleObj = 0D;

    @Field(name = "in_bigint")
    private BigInteger inBigInteger = BigInteger.ZERO;

    @Field(name = "in_decimal")
    private BigDecimal inDecimal = BigDecimal.ZERO;

    @Field(name = "in_boolean")
    private boolean inBoolean = Boolean.TRUE;

    @Field(name = "in_booleanObj")
    private Boolean inBooleanObj = Boolean.TRUE;
