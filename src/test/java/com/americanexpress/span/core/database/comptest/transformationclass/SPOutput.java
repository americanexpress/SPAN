...
public class SPOutput {
    ...
    @Field(name = "out_boolean", transformationClass = BooleanToString.class)
    private String outBoolean;

    @Field(name = "out_booleanObj", transformationClass = BooleanToString.class)
    private String outBooleanObj;
    ...
    public String getOutBooleanObj() {
        return outBooleanObj;
    }

    public void setOutBooleanObj(String outBooleanObj) {
