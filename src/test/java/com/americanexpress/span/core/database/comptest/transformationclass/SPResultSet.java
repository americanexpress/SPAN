...
public class SPResultSet {
    ...
    @Field(name = "rs_int", transformationClass = IntegerToRange.class)
    private RangeEnum rsInt;

    @Field(name = "rs_integer", transformationClass = IntegerToRange.class)
    private RangeEnum rsInteger;
    ...
    public RangeEnum getRsInt() {
        return rsInt;
    }

    public void setRsInt(RangeEnum rsInt) {
        this.rsInt = rsInt;
    }

    public RangeEnum getRsInteger() {
        return rsInteger;
    }

    public void setRsInteger(RangeEnum rsInteger) {
